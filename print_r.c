 ...
 * @l: the argument from _printf
 * @f: the pointer to the struct flags that tells
 * if a flag is passed to _printf
 ...
 * @l: the list of arguments from _printf
 * @f: pointer to the struct flags that tells
 * if a flag is passed to _printf
 * Return: the length of the printed string
 */
 ...
 * @l:the va_list arguments from _printf
 * @f: the pointer to the struct flags
 * in which we turn the flags on.
